		...
		<div class="panel-body">
	        ...
	        <div class="form-group">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-2">
				  <input class="form-control" type="text" name="realName"  id="realName" placeholder="姓名" value="${(userInfo.realName)!}" required>
				</div>
				<label class="col-sm-1 control-label" for="phone">手机：</label>
				<div class="col-sm-3">
				  <input class="form-control" type="text" name="phone"  id="phone" placeholder="手机号" value="${(userInfo.phone)!}" required>
				</div>
			  </div>		
			  <div class="form-group">
